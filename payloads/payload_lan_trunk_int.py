class data:
    def __init__(self):
        self.payload = """        
        {
            "templateName": "LAN-Physical-Int-Trunk",
            "templateDescription": "Physical Interface Template with no IP address assigned, used for sub-interface templates",
            ...
            "templateDefinition": {
                "if-name": {
                    ...
                    "vipValue": "",
                    "vipVariableName": "lan_trunk_if_name"
                },
                "description": {
                    "vipObjectType": "object",
                    "vipType": "constant",
