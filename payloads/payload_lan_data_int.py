class data:
    def __init__(self):
        self.payload = """
            {
                "templateName": "LAN-Data-Interface",
                "templateDescription": "LAN Data interface template for remote site routers",
                ...
                "templateDefinition": {
                    "if-name": {
                        ...
                        "vipValue": "",
                        "vipVariableName": "lan_data_if_name"
                    },
                    "description": {
                        "vipObjectType": "object",
                        "vipType": "constant",
                    ...
                    "ip": {
                        "address": {
                            ...
                            "vipType": "variableName",
                            "vipValue": "",
                            "vipVariableName": "lan_data_if_ipv4_address"
                        },
                        "secondary-address": {
                            "vipType": "ignore",
                            "vipValue": [],
                    ...
                    "mtu": {
                        ...
                        "vipType": "variableName",
                        "vipValue": "",
                        "vipVariableName": "lan_data_if_ip_mtu"
                    },
                    "static-ingress-qos": {
                        "vipObjectType": "object",
                        "vipType": "ignore",
