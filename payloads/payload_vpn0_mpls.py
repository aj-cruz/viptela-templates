class data:
    def __init__(self):
        self.payload = """
        {
            "templateName": "VPN0-MPLS-Interface",
            "templateDescription": "VPN0 MPLS Interface for all routers",
            ...
            "templateDefinition": {
                "if-name": {
                    ...
                    "vipValue": "",
                    "vipVariableName": "vpn0_mpls_physical_if_name"
                },
                "description": {
                    "vipObjectType": "object",
                    "vipType": "constant",
                    "vipValue": "MPLS Transport",
                    "vipVariableName": "vpn_mpls_if_description"
                },
                "ip": {
                    "address": {
                        "vipObjectType": "object",
                        "vipType": "variableName",
                        "vipValue": "",
                        "vipVariableName": "vpn0_mpls_if_ipv4_address"
                    },
                    "secondary-address": {
                        "vipType": "ignore",
                        "vipValue": [],
